...
const tokens: ChainTokenList = {
  ...
  [ChainId.TESTNET]: [
    ...
    // new Token(ChainId.TESTNET, '0x043a3737fcd6638ae58fc9e497cee036333f02984e4ff4deaf512333b6220481', 18, 'TKC', 'TestMainnet Token'),
    // new Token(ChainId.TESTNET, '0x060079a4e9c922f8143c1b8670c053cec37db6b3894e3e2129f0a408b47dfac3', 18, 'TKD', 'TestMainnet Token'),
  ],
}
